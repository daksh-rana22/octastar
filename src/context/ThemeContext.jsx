...
export const colorThemes = [
  ...
  },
  {
    ...
    gradient: 'linear-gradient(135deg, #3B82F6 0%, #68A9E8 40%, #A0D2EB 75%, #D0BDF4 100%)',
    swatch: ['#3B82F6', '#68A9E8', '#A0D2EB', '#D0BDF4'],
    navy900: '#0E1726',
    navy800: '#152238',
    navy700: '#1D2D4A',
    navy600: '#26395C',
    navy500: '#334B75',
    containerBg: '#1F3A60',
    containerHover: '#182E4D',
    textPrimary: '#F0F6FC',
    textSecondary: '#A5C4E8',
    textMuted: '#6E88A8',
    border: '#26395C',
    borderHover: '#3B82F6',
    surfaceLight: '#FFFFFF',
    surfaceCard: '#F3F8FC',
    textOnLight: '#0B1727',
    textOnLightSecondary: '#334E68',
    textOnLightMuted: '#627D98',
    borderLight: '#D9E4EC',
    badgeBg: 'rgba(59, 130, 246, 0.12)',
    badgeText: '#2563EB',
    buttonDark: '#0B1727',
    buttonDarkHover: '#1B3150',
  },
];
